...
%include version.ks
mkdir -p $INSTALL_ROOT/usr/share/OCselected-oVirt-Engine-Appliance
LATEST_APPLIANCE=`ls -tr /data/testing/OCselected-oVirt/OCselected-oVirt-Engine-Appliance-*.ova.gz | tail -n 1`
cp -v $LATEST_APPLIANCE $INSTALL_ROOT/usr/share/OCselected-oVirt-Engine-Appliance
